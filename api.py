...
# Read user
@api.route("/api/get_user/<user_id>", methods=["GET"])
...
# Update user
@api.route("/api/update_user/<user_id>", methods=["PUT"])
...
@api.route("/api/ratings/<user_id>/<system>", methods=["GET"])
def api_get_ratings(user_id, system):
    ratings = get_ratings(user_id, system)
    return jsonify(ratings), 200

@api.route("/api/ratings/<user_id>/<system>", methods=["DELETE"])
...
#-------- SINGLE RATING CRUD ---------
# Add a single rating
@api.route("/api/rating", methods=["POST"])
def api_add_rating():
    data = request.json
...
@api.route("/api/rating", methods=["PUT"])
...
@api.route("/api/rating", methods=["DELETE"])
...
@api.route("/api/system/<system_id>", methods=["GET"])
...
@api.route("/api/system/<system_id>", methods=["PUT"])
...
@api.route("/api/system/<system_id>", methods=["DELETE"])
...
@api.route("/api/systems", methods=["GET"])
